...
// --- DADOS MULTILÍNGUES DO CURRÍCULO ---
...
const resumeData = {
    ...
    sections: {
        ...
        courses: { ptBR: "Cursos Relevantes", en: "Relevant Courses", es: "Cursos Relevantes" },
    ...
    experiences: [
        ...
        },
        {
            ...
            company: "Wortsman", period: "2017 - 2019",
            tasks: [
    ...
    cards: [
        {
            ...
            title: { ptBR: "Ver Meus Projetos", en: "View My Projects", es: "Ver Mis Proyectos" },
            description: { ptBR: "Explore uma seleção dos meus melhores trabalhos e estudos de caso.", en: "Explore a selection of my best works and case studies.", es: "Explora una selección de mis mejores trabajos y casos de estudio." },
            link: "/projetos"
        },
        {
            icon: <Send size={32} />,
            title: { ptBR: "Entrar em Contato", en: "Get in Touch", es: "Contactar" },
            description: { ptBR: "Tem uma ideia ou oportunidade? Vamos conversar.", en: "Have an idea or an opportunity? Let's talk.", es: "Tienes una idea o una oportunidad? Hablemos." },
            link: "/contato"
        }
    ]
};
...
export default function ResumePage() {
    return (
        <div className="bg-background text-foreground">
            <header className="relative pt-40 pb-24 text-center text-white overflow-hidden">
            ...
            <main className="max-w-7xl mx-auto p-4 md:p-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    ...
                    <motion.div {...sectionAnimation} className="lg:col-span-2 flex flex-col gap-12">
                        <section>
                ...
                <motion.section {...sectionAnimation} className="mt-24 py-16 text-center">
