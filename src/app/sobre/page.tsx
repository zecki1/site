...
export default function AboutPage() {
    return (
        <div className="relative bg-background text-foreground min-h-screen overflow-hidden isolate pt-40">
            ...
            {/* Conteúdo Principal */}
            <main className="max-w-4xl mx-auto p-4 md:p-8 space-y-16 my-16  bg-background/70 backdrop-blur-md">
