...
import { YouTubeBackground } from "@/components/layout/YouTubeBackground"; // Importe o novo componente
...
// Animação para texto e elementos aparecerem
            ...
            <section className="min-h-screen flex flex-col justify-center p-8 md:p-16">
                <div className="max-w-7xl mx-auto w-full">
                    <motion.h3 {...revealAnimation} className="text-sm uppercase text-muted-foreground mb-8">
                        <TextTranslator>{{ ptBR: "O que eu ofereço", en: "What I Offer", es: "Lo que ofrezco" }}</TextTranslator>
                    </motion.h3>
                    <motion.div>
                        {[
